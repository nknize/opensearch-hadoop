 ...
 */
public class OpenSearchAssume {

    public static void versionOnOrAfter(OpenSearchMajorVersion version, String message) {
        assumeTrue(message, getVersion().onOrAfter(version));
    }

    public static void versionOn(OpenSearchMajorVersion version, String message) {
        assumeTrue(message, getVersion().onOrAfter(version));
    }

    public static void versionOnOrBefore(OpenSearchMajorVersion version, String message) {
