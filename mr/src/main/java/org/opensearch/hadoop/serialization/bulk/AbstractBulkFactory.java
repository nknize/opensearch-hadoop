...
import org.opensearch.hadoop.serialization.dto.mapping.MappingUtils;
import org.opensearch.hadoop.serialization.field.ChainedFieldExtractor;
...
import org.opensearch.hadoop.util.BytesArrayPool;
...
public abstract class AbstractBulkFactory implements BulkFactory {
    ...
    protected void writeObjectHeader(List<Object> list) {
        ...
        commaMightBeNeeded = addExtractorOrDynamicValue(list, getMetadataExtractorOrFallback(MetadataExtractor.Metadata.INDEX, indexExtractor), "", commaMightBeNeeded);
        commaMightBeNeeded = addExtractorOrDynamicValue(list, getMetadataExtractorOrFallback(MetadataExtractor.Metadata.TYPE, typeExtractor), "\"_type\":", commaMightBeNeeded);
        ...
        if (versionField != null) {
            ...
            Object versionTypeField = getMetadataExtractorOrFallback(MetadataExtractor.Metadata.VERSION_TYPE, versionTypeExtractor);
    ...
    protected boolean id(List<Object> list, boolean commaMightBeNeeded) {
        return addExtractorOrDynamicValue(list, getMetadataExtractorOrFallback(MetadataExtractor.Metadata.ID, idExtractor), "\"_id\":", commaMightBeNeeded);
    }
     ...
     */
    protected FieldExtractor getMetadataExtractorOrFallback(MetadataExtractor.Metadata meta, FieldExtractor fallbackExtractor) {
