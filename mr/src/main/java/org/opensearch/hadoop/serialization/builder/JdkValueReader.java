...
public class JdkValueReader extends AbstractValueReader implements SettingsAware {
    ...
    protected Collection<FieldFilter.NumberedInclude> arrayInclude = Collections.<FieldFilter.NumberedInclude> emptyList();
    ...
    public Object addToArray(Object array, List<Object> value) {
        ...
        if (ctx != null && ctx.getArrayDepth() == 0) {
            ...
            FieldFilter.Result result = FieldFilter.filter(ctx.getFieldName(), arrayInclude, arrayExclude, false);
